  ...
  <div class="pop_mask2">
    <div class="popup_box">
      <div class='pop-header'
           style="background-color: #00758f">
        <span class="poptitle">申请试用/体验</span>
      ...
      <div class="row pop-content">
        ...
        <div class=" col-md-7 col-sm-7">
          <input type="hidden"
                 ...
                 value="sbzc2">
          <div class="rowinfo">
            <span class="joinustitle">姓名</span><i class="joinico">*</i><input type="text"
                   id="name2"
                   placeholder="请输入联系人"
                   class="input_com1 border-a name"
                   autocomplete="off">
          </div>
          <div class="clearfix"></div>
          <div class="rowinfo">
            <span class="joinustitle">电话</span><i class="joinico">*</i><input type="text"
                   id="phone2"
                   placeholder="请输入联系方式"
                   class="input_com1 border-a tel"
                   autocomplete="off">
          </div>
          <div class="clearfix"></div>
          <div class="rowinfo">
            <span class="joinustitle">邮箱</span><i class="joinico">*</i><input type="text"
                   id="email2"
                   placeholder="请输入邮箱"
                   class="input_com1 border-a email"
                   autocomplete="off">
          </div>
          <div class="clearfix"></div>
          <div class="rowinfo">
            <span class="joinustitle">公司</span><i class="joinico"></i><input type="text"
                   id="company2"
                   placeholder="请输入公司"
                   class="input_com1 border-a company"
                   autocomplete="off">
          </div>
          <div class="clearfix"></div>
          <div class="rowinfo">
            <span class="joinustitle"></span><i class="joinico"></i> <input type="submit"
                   value="申请试用"
                   class="input_com2 border-a login-btn2"
                   id="join2"
                   style="background-color: #00758f" />
          </div>
          <div class="clearfix"></div>
...
export default {
  mounted () {
    ...
    //提交联系方式
    $(".join").click(function () {
      var url = "http://203.195.202.167:8080/biaoshi/cgFormBuildController.do?saveOrUpdate"
      var name = $(".name").val()
      var tel = $(".tel").val()
    ...
    $(".try").click(function () {
      ...
      var reg = /^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$/
      if (!reg.test(email) && email != "") { //正则验证不通过，格式不对
        alert("请输入正确的邮箱!");
        return false;
      }
...
<style  src="../../assets/css/pop.css"  scoped>
</style>
